...
$this->title = Common::icon('list')." ".Yii::t('BackEnd', '<?php echo $this->pluralize($this->class2name($this->modelClass)); ?>');
?>
...
?>
		array(
			'class'=>'CButtonColumn',
            'template'=> UserAccess::checkAccess('<?php echo $this->modelClass; ?>Update')? '{view}{update}{delete}':'{view}{update}',
		),
	),
)); ?>
